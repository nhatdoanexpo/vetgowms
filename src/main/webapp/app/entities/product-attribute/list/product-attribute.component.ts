...
import { EntityArrayResponseType, ProductAttributeService } from '../service/product-attribute.service';
...
export class ProductAttributeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProductAttribute): number => this.productAttributeService.getProductAttributeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.productAttributes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IProductAttribute[] | null): IProductAttribute[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.productAttributeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
