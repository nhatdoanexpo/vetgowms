...
import vn.vetgo.wms.repository.ProductRepository;
import vn.vetgo.wms.service.ProductService;
import vn.vetgo.wms.service.dto.ProductDTO;
import vn.vetgo.wms.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.vetgo.wms.domain.Product}.
 */
@RestController
@RequestMapping("/api")
