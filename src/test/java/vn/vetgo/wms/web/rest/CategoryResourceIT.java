...
import static vn.vetgo.wms.web.rest.TestUtil.sameInstant;
...
class CategoryResourceIT {
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getRetailerId()).isEqualTo(DEFAULT_RETAILER_ID);
    ...
    void putExistingCategory() throws Exception {
        ...
        assertThat(testCategory.getRetailerId()).isEqualTo(UPDATED_RETAILER_ID);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.categoryId(UPDATED_CATEGORY_ID).createdDate(UPDATED_CREATED_DATE).parentId(UPDATED_PARENT_ID);
